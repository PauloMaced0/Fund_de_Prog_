'''*O programa insertionSort.py tem uma implementação do algoritmo de
ordenação por inserção. Modifique a função para aceitar um argumento opcional key=
que funcione tal como na função pré-definida sorted.'''
