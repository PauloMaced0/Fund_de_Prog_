...
dif_golos = lambda golos : golos[GM] - golos[GS]
...
def main():
    ...
    print('TABELA ORDENADA POR PONTOS (ORDEM DESCRESCENTE)')
    ...
    print('TABELA ORDENADA POR GM-GS(ORDEM DECRESCENTE)')
    tab = sorted(tabela, key = dif_golos, reverse=True)
    printTabela(tab)
    ...
    print('TABELA ORDENADA POR PONTOS / PONTOS e GM-GS, CASO IGUAIS (ORDEM DECRESCENTE)')
    tab = sorted(tabela, key= lambda team : (pontos(team), dif_golos(team)), reverse=True)
    printTabela(tab)
